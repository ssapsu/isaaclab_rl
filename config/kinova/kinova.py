...
KINOVA_GEN3_CFG = ArticulationCfg(
    ...
    actuators={
        ...
        "gen3_hand": ImplicitActuatorCfg(
            joint_names_expr=["robotiq_85_right_knuckle_joint", "robotiq_85_right_inner_knuckle_joint", "robotiq_85_left_inner_knuckle_joint", "robotiq_85_left_knuckle_joint"],
            effort_limit=200.0,
            velocity_limit=0.2,
            stiffness=2e3,
            damping=1e2,
